...
class  Quiz_Code_In extends JFrame implements ActionListener{
        ...
        public void initializedata(){
                        ...
                        qpa[0][0]="In 2005 which government voted to adopt open source?";
                        qpa[0][1]="Peru";
                        qpa[0][2]="India";
                        qpa[0][3]="Australia";
                        qpa[0][4]="Brazil";

                        qpa[1][0]="Which year did US White house move its website to linux?";
                        qpa[1][1]="2002";
                        qpa[1][2]="2009";
                        qpa[1][3]="2013";
                        qpa[1][4]="2015";
                        ...
                        qpa[3][1]="Computer software which is free";
                        qpa[3][2]="Mobile software which is free.";
                        qpa[3][3]="Wear software which is free.";
                        ...
                        qpa[6][0]="Which was the first state to declare its support for FOSS?";
                        qpa[6][1]="New Delhi";
                        qpa[6][2]="Karnataka";
                        qpa[6][3]="Kerala";
                        qpa[6][4]="Goa";
                        ...
                        qca[0][0]="In 2005 which government voted to adopt open source?";
                        qca[0][1]="Peru";

                        qca[1][0]="Which year did US White house move its website to linux?";
                        qca[1][1]="2009";

                        qca[2][0]="Whats the full form of FOSS";
                        qca[2][1]="Free and open source software";

                        qca[3][0]="What is FOSS??";
                        qca[3][1]="Computer software which is free.";
                        ...
                        qca[6][0]="Which was the first state to declare its support for FOSS?";
                        qca[6][1]="Kerala";
